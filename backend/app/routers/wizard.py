...
def _blank_entry(project: str, entered_by: Optional[str] = None) -> dict:
    ...
    rec = DCR(
        ...
        source="tracker",
        project=project,
        entered_by=entered_by or None,  # set to the reviewer when the draft is confirmed
...
def _compile_project(project: str, entered_by: Optional[str] = None) -> dict:
    ...
    # Create a draft DCR from the extraction ("" means unknown in the extraction -> leave the field empty)
    ...
    rec = DCR(
        ...
        project=project,
        type=extraction.type or None,
        category=extraction.category or None,
        critical=extraction.critical or None,
        occurred_on=extraction.occurred_on or None,
        amex_office=extraction.amex_office or None,
        pharma=extraction.pharma or None,
        supplier=extraction.supplier or None,
        customer=extraction.customer or None,
        responsible_party=extraction.responsible_party or None,
        responsible_party_name=extraction.responsible_party_name or None,
        description=extraction.description or None,
        root_cause=extraction.root_cause or None,
        financial_impact=extraction.financial_impact or None,
        actions_taken=extraction.actions_taken or None,
        capa_needed=extraction.capa_needed or None,
        closure_date=extraction.closure_date or None,
        entered_by=entered_by or None,  # set to the reviewer when the draft is confirmed
        extraction_method=method,
        freight_forwarder=extraction.freight_forwarder or None,
        reported_by_party=extraction.reported_by_party or None,
        requested_actions=extraction.requested_actions or None,
    )
